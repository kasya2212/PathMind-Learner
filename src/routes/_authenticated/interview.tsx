          ...
          <div className="flex flex-wrap items-center justify-between gap-3 px-5 py-4">
            <div className="min-w-0">
              ...
              <p className="mt-0.5 text-xs text-muted-foreground">
                Started {new Date(active.started_at).toLocaleString()} · your answers so far are
                saved.
              </p>
            </div>
      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px]">
        <Card>
          ...
          <div className="space-y-6 px-5 pb-6 pt-2 sm:px-6">
            ...
            <Field
              label="Duration"
              hint={`Up to ${INTERVIEW_MAX_LEARNER_TURNS} questions — the interview wraps up early when you reach the limit.`}
            >
              <Segmented<number>
                ariaLabel="Duration"
                value={duration}
